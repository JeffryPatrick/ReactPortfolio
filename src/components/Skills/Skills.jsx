        ...
        <section id="skills" className="section">
            ...
            <div className="skill-content">
                <div className="details">
                    ...
                    <div className="inner">
                        <svg xmlns="http://www.w3.org/2000/svg" height="32px" width="32px" viewBox="0 0 512 512">
                            <path opacity="1" fill="black"
